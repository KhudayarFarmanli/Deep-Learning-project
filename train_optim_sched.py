...
if args.scheduler == "plateau":
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode = 'min', factor = 0.1, patience = 1, threshold = 0.005, threshold_mode='rel', cooldown=0, min_lr=0, eps=1e-08, verbose=True)
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max = math.ceil(args.queries_per_epoch / args.cache_refresh_rate)*args.epochs_num, eta_min = 0, last_epoch=- 1, verbose=True)
