...
triplets_ds = datasets_constant.TripletsDataset(args, args.datasets_folder, args.dataset_name, "train", args.negs_num_per_query)
logging.info(f"Train query set: {triplets_ds}")

val_ds = datasets_constant.BaseDataset(args, args.datasets_folder, args.dataset_name, "val")
logging.info(f"Val set: {val_ds}")

test_ds = datasets_constant.BaseDataset(args, args.datasets_folder, args.dataset_name, "test")
...
for epoch_num in range(start_epoch_num, args.epochs_num):
    ...
    for loop_num in range(loops_num):
        ...
        triplets_dl = DataLoader(dataset=triplets_ds, num_workers=args.num_workers,
                                 ...
                                 collate_fn=datasets_constant.collate_fn,
