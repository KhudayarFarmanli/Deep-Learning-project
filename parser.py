...
def parse_arguments():
    ...
    #Project parrameters
    parser.add_argument("--multi_scale_test", action='store_true', help="Option of testing the model with several low image resolutions")
    parser.add_argument ("--comparison", action = 'store_true', help = "Option of ensembling - Adding another args.resume to load two models instead of only one")
    parser.add_argument ("--resume_compar", type=str, default=None, help="Path to load checkpoint (the comparison model) from, for resuming training or testing.")
    parser.add_argument("--save_alt_dir", type=str, default="default",
                        help="Folder name of the current run of the comparison model (saved in ./logs/)")
    parser.add_argument("--bright_improv", type=float, default=None, help="_")
    
    parser.add_argument("--brightness_r", type=float, default=None, help="_")
    parser.add_argument("--contrast_r", type=float, default=None, help="_")
    parser.add_argument("--saturation_r", type=float, default=None, help="_")
    parser.add_argument("--hue_r", type=float, default=None, help="_")
    ...
    parser.add_argument("--wd", type=float, default=0, help="_")
    ...
    parser.add_argument("--optim", type=str, default="adam", help="_", choices=["adam", "sgd", "adamw", "asgd"]) #newly added optimizers<---------------
    parser.add_argument("--scheduler", type=str, default="plateau", help="_", choices=["plateau", "cosine"])
    ...
    parser.add_argument("--data_aug", action='store_true', help="_")
    parser.add_argument("--night_robust", action='store_true', help="_")
    parser.add_argument("--color_jitter", action='store_true', help="_")
    parser.add_argument("--functional_adjust", action='store_true', help="_")
    parser.add_argument("--pers_ocl_robust", action='store_true', help="_")
    ...
    parser.add_argument("--rand_perspective_dist", type=float, default=None, help="_")
    parser.add_argument("--rand_perspective_prob", type=float, default=None, help="_")
    parser.add_argument("--rand_perspective_fill", type=int, default=None, help="_")
    parser.add_argument("--rand_erasing_prob", type=float, default=None, help="_")
